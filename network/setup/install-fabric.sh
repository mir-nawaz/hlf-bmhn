...
#bash ./bootstrap.sh  2.0.0 1.4.4 0.4.18 -s
...
git clone https://github.com/hyperledger/fabric.git -b release-1.4
mkdir -p $GOPATH/src/github.com/hyperledger/
cp -r ./fabric $GOPATH/src/github.com/hyperledger/
go build github.com/hyperledger/fabric/core/chaincode/shim
